...
export default function ActiveChat({
        ...
        <div>
          ...
          <div
            style={{
              display: "flex",
              justifyContent:
                targetedUser._id === message.sender ? "start" : "end",
            }}
          >
            <div
              style={{
                ...
                backgroundColor:
                  targetedUser._id === message.sender ? "#738F88" : "#98C8BC99",
                maxWidth: "100%",
                borderRadius:
                  targetedUser._id === message.sender
                    ? "24px 24px 24px 0px"
                    : "24px 24px 0px 24px",
                margin: "10px 0",
              }}
  ...
  return (
    ...
    >
      <BackHeader targetedUser={targetedUser} />
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            ...
            >
              <path
                d="M1.66669 4.99984L5.00002 8.33317L11.6667 1.6665"
                stroke="black"
                stroke-width="1.5"
            ...
            {/*TODO : Hasan*/}
            {t("activeChatDelivered")}:{" "}
            <span style={{ marginLeft: "auto" }}>
              {getTime(targetedMessage?.seen[0]?.date)}
            </span>
          </div>
          {checkValidDate(new Date(targetedMessage?.seen[1]?.date)) && (
            <div
              style={{
                ...
                alignItems: "center",
                padding: "5px",
                borderTop: "1px solid rgba(34, 23, 42, 0.08)",
              }}
            >
              <svg
                style={{ width: "25px" }}
              ...
              >
                <g clip-path="url(#clip0_218_3343)">
                  <path
                    d="M4.66669 7.99984L8.00002 11.3332L14.6667 4.6665"
                    stroke="black"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  />
                  <path
                    d="M7.99998 7.99984L11.3333 4.6665M1.33331 7.99984L4.66665 11.3332L1.33331 7.99984Z"
                    stroke="black"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              {t("activeChatRead")}:{" "}
              <span style={{ marginLeft: "auto" }}>
                {getTime(targetedMessage?.seen[1]?.date)}
              </span>
            </div>
          )}
        </Modal.Body>
